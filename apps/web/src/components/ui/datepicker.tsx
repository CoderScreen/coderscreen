...
//         focusInput,
//         // invalid (optional)
//         'invalid:border-red-500 invalid:ring-2 invalid:ring-red-200 group-aria-[invalid=true]/time-input:border-red-500 group-aria-[invalid=true]/time-input:ring-2 group-aria-[invalid=true]/time-input:ring-red-200 group-aria-[invalid=true]/',
//         {
...
//               <div
//                 className={cx(
//                   'relative flex h-12 w-full items-center sm:h-full sm:w-40',
...
//                 </div>
//               )}
//               <div className='flex items-center gap-x-2 border-t border-gray-300 p-3'>
//                 <Button
//                   variant='secondary'
...
//                 classNames={{
//                   months:
//                     'flex flex-row divide-x divide-gray-300 overflow-x-scroll',
//                 }}
//                 {...props}
//               />
//               {showTimePicker && (
//                 <div className='flex items-center justify-evenly gap-x-3 border-t border-gray-300 p-3'>
...
//                 </div>
//               )}
//               <div className='border-t border-gray-300 p-3 sm:flex sm:items-center sm:justify-between'>
