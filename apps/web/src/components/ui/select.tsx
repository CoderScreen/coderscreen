...
>(({ className, hasError, children, ...props }, forwardedRef) => {
  return (
    <SelectPrimitives.Trigger
      ref={forwardedRef}
      className={cx('relative', selectTriggerStyles, hasError ? hasErrorInput : '', className)}
      {...props}
    >
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine
          className={cx(
            ...
            'text-stone-400',
            // disabled
            'group-data-[disabled]/trigger:text-stone-300 group-data-[disabled]/'
          )}
        />
  ...
  (
    ...
    <SelectPrimitives.Portal>
      <SelectPrimitives.Content
        ...
        className={cx(
          // base
          'relative z-[302] overflow-hidden rounded-md border shadow-xl shadow-black/[2.5%]',
          // widths
  ...
  return (
    <SelectPrimitives.Item
      ...
      className={cx(
        ...
        'text-stone-900',
        // disabled
        'data-[disabled]:pointer-events-none data-[disabled]:text-stone-400 data-[disabled]:hover:bg-none',
        // focus
    ...
    >
      ...
      <SelectPrimitives.ItemIndicator>
        <RiCheckLine className='size-5 shrink-0 text-stone-800' aria-hidden='true' />
      </SelectPrimitives.ItemIndicator>
    </SelectPrimitives.Item>
  );
});
