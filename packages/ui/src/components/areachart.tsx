    ...
    const PulsingDot = ({
      ...
      <g>
        <circle
          ...
          cy={cy}
          r={5}
          className='animate-pulse-ring fill-none stroke-2'
        />
        <circle cx={cx} cy={cy} r={5} className='animate-pulse' />
      </g>
    );
      ...
      <div ref={ref} className={cx('h-80 w-full', className)} {...other}>
        <ResponsiveContainer>
          ...
          >
            ...
            {/* Pulsing dots at the end of each line */}
            {showPulsingDot &&
              categories.map((category) => {
                const lastDataPoint = data[data.length - 1];
                const value = lastDataPoint?.[category];

                // Skip if no value for this category in the last data point
                        ...
                        <g>
                          ...
                          <circle
                            ...
                            className={cx(
                              ...
                              'animate-ping fill-none opacity-75 stroke-[1.5]'
                            )}
                          />
                        </g>
                      );
